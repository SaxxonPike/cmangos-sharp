...
public sealed class ClassiccharactersDbContext : DbContext
{
    ...
    {
        builder.Entity<AhbotItems>().HasKey(e => new { e.Item });
        ...
        builder.Entity<CharacterAction>().HasKey(e => new { e.Guid, e.Button });
        builder.Entity<CharacterAura>().HasKey(e => new { e.Guid, e.CasterGuid, e.ItemGuid, e.Spell });
        builder.Entity<CharacterBattlegroundData>().HasKey(e => new { e.Guid });
        builder.Entity<CharacterGifts>().HasKey(e => new { e.Guid, e.ItemGuid });
        builder.Entity<CharacterHomebind>().HasKey(e => new { e.Guid });
        builder.Entity<CharacterHonorCp>().HasKey(e => new { e.Guid });
        builder.Entity<CharacterInstance>().HasKey(e => new { e.Guid, e.Instance });
        builder.Entity<CharacterInventory>().HasKey(e => new { e.Guid, e.Item });
        builder.Entity<CharacterPet>().HasKey(e => new { e.Id });
        builder.Entity<CharacterQueststatus>().HasKey(e => new { e.Guid, e.Quest });
        builder.Entity<CharacterQueststatusWeekly>().HasKey(e => new { e.Guid, e.Quest });
        builder.Entity<CharacterReputation>().HasKey(e => new { e.Guid, e.Faction });
        builder.Entity<CharacterSkills>().HasKey(e => new { e.Guid, e.Skill });
        builder.Entity<CharacterSocial>().HasKey(e => new { e.Guid, e.Friend, e.Flags });
        builder.Entity<CharacterSpell>().HasKey(e => new { e.Guid, e.Spell });
        builder.Entity<CharacterSpellCooldown>().HasKey(e => new { e.Guid, e.SpellId });
        builder.Entity<CharacterStats>().HasKey(e => new { e.Guid });
        builder.Entity<CharacterTutorial>().HasKey(e => new { e.Account });
        builder.Entity<Characters>().HasKey(e => new { e.Guid });
        builder.Entity<Corpse>().HasKey(e => new { e.Guid });
        ...
        builder.Entity<GmSurveys>().HasKey(e => new { e.Ticketid });
        builder.Entity<GameobjectRespawn>().HasKey(e => new { e.Guid, e.Instance });
        builder.Entity<GroupInstance>().HasKey(e => new { e.LeaderGuid, e.Instance });
        builder.Entity<GroupMember>().HasKey(e => new { e.GroupId, e.MemberGuid });
        builder.Entity<Groups>().HasKey(e => new { e.GroupId });
        builder.Entity<Guild>().HasKey(e => new { e.Guildid });
        builder.Entity<GuildEventlog>().HasKey(e => new { e.Guildid, e.LogGuid });
        builder.Entity<GuildMember>().HasKey(e => new { e.Guildid, e.Guid });
        ...
        builder.Entity<ItemInstance>().HasKey(e => new { e.Guid });
        builder.Entity<ItemLoot>().HasKey(e => new { e.Guid, e.Itemid });
        builder.Entity<ItemText>().HasKey(e => new { e.Id });
        builder.Entity<Mail>().HasKey(e => new { e.Id });
        builder.Entity<MailItems>().HasKey(e => new { e.MailId, e.ItemGuid });
        builder.Entity<PetAura>().HasKey(e => new { e.Guid, e.CasterGuid, e.ItemGuid, e.Spell });
        builder.Entity<PetSpell>().HasKey(e => new { e.Guid, e.Spell });
        builder.Entity<PetSpellCooldown>().HasKey(e => new { e.Guid, e.Spell });
        builder.Entity<Petition>().HasKey(e => new { e.Ownerguid });
        builder.Entity<PetitionSign>().HasKey(e => new { e.Ownerguid, e.Petitionguid, e.Playerguid });
        builder.Entity<PlayerbotSavedData>().HasKey(e => new { e.Guid });
        builder.Entity<PvpstatsBattlegrounds>().HasKey(e => new { e.Id });
        builder.Entity<PvpstatsPlayers>().HasKey(e => new { e.BattlegroundId, e.CharacterGuid });
        builder.Entity<SavedVariables>().HasKey(e => new { e.NextWeeklyQuestResetTime });
        builder.Entity<World>().HasKey(e => new { e.Map });
