...
public sealed class ClassicrealmdDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<AccountRaf>().HasKey(e => new { e.Referrer, e.Referred });
        builder.Entity<IpBanned>().HasKey(e => new { e.Ip, e.BannedAt });
        builder.Entity<Realmcharacters>().HasKey(e => new { e.Realmid, e.Acctid });
        builder.Entity<Realmlist>().HasKey(e => new { e.Id });
        builder.Entity<Uptime>().HasKey(e => new { e.Realmid, e.Starttime });
